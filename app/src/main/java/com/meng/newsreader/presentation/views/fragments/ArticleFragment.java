...
public class ArticleFragment extends Fragment {
    ...
    public static ArticleFragment newInstance(int article) {
    ...
    private void updateArticle(final int articleId) {
        ArticleListFragment articleListFragment = (ArticleListFragment)
                getActivity().getFragmentManager().findFragmentByTag(ArticleListFragment.TAG);
